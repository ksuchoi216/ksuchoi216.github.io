var store = [{
        ...
        "title": "시계열 이미지와 시계열 데이터를 같이 처리할 순 없을까? CrossViViT",
        "excerpt":"1. 연구자가 이루고자 한 것은 무엇인가요(Why)? 시계열 이미지와 시계열 데이터를 통해 예측을 하고 싶은 문제들이 있습니다. 이 논문에서는 Solar Irradiance(일사량)라는 문제를 해결하고 싶었습니다.시계열 이미지는 동영상에서 프레임 단위 이미지라고 생각하면 쉽습니다. t=1 시점에 frame 이미지과 t=2 시점 frame 이미지를 생각하면 이 2개 이미지는 시계열 관계에 있습니다. 일사량에서 보자면 위성 사진을 생각할...","categories": ["time-series"],
        "tags": ["pv","transformer","vision"],
        "url": "http://localhost:4000/time-series/2024/02/15/crossvivit.html"
      },{
        "title": "PatchTST",
        "excerpt":"summary: The PatchTST method aims to achieve structural features by dividing time series using patches and independently training each channel. The key features include maintaining local information through embedding, reducing computation and memory usage, and utilizing more past data. The method employs patch embedding and independent channel transformers. The results...","categories": ["Papers"],
        "tags": ["seperated","test","tsf"],
        "url": "http://localhost:4000/papers/2024/05/30/PatchTST.html"
      }]
