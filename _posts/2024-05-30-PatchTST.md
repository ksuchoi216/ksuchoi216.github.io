...
tags:
    ...
    - tsf
image: 
    path: /images/PatchTST/PatchTST_img_00.png
    thumbnail: /images/PatchTST/PatchTST_img_00.png
---


summary: The PatchTST method aims to achieve structural features by dividing time series using patches and independently training each channel. The key features include maintaining local information through embedding, reducing computation and memory usage, and utilizing more past data. The method employs patch embedding and independent channel transformers. The results show good performance regardless of the data and input data length. The advantages include the ability to handle data of any length, while the disadvantages include the inherent computational and memory limitations of the transformer-based model and the varying effectiveness of channel independence depending on the data.
<!--more-->
