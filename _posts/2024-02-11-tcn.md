...
tags:
   - cnn
image:
     path: /images/tcn/main.png
     thumbnail: /images/tcn/main.png
---
...
![Pasted image 20240205190726.png](/images/tcn/Pasted image 20240205190726.png){:, .align-center}
## Results

아래 그래프를 보시면 입력 시계열 길이가 늘어도 TCN이 성능이 좋은 것을 알 수 있습니다.

![Pasted image 20240205190746.png](/images/tcn/Pasted image 20240205190746.png){:, .align-center}

또한 Accuarcy관점에서 봐도 LSTM, GRU를 압도합니다.
![Pasted image 20240205190806.png](/images/tcn/Pasted image 20240205190806.png){:, .align-center}
